...
formula_pattern_coverage indica total/shown/omitted de nodos de fórmula del grafo. Los patrones omitidos no demuestran ausencia de fórmulas ni valores en caché. Usa external_workbooks para describir los archivos externos referenciados: los libros no leídos no se abrieron del disco; las celdas dependientes usan cachés internos incrustados o carecen de valor. Al explicar intervalos o restricciones, indica explícitamente el límite inferior y superior sin omitir el inferior.
