...
formula_pattern_coverage donne total/shown/omitted pour les nœuds de formule du graphe. Un motif omis ne prouve l’absence ni de formule ni de cache. Utilise external_workbooks pour décrire les fichiers externes référencés : les classeurs non lus n’ont pas été ouverts depuis le disque ; les cellules dépendantes utilisent des caches internes incorporés ou n’ont pas de valeur. Quand tu expliques des intervalles ou contraintes, mentionne explicitement la borne inférieure et la borne supérieure sans omettre la borne inférieure.
