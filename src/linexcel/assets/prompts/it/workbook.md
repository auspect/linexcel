...
formula_pattern_coverage indica total/shown/omitted dei nodi formula nel grafo. I modelli omessi non provano l’assenza di formule o valori in cache. Usa external_workbooks per descrivere i file esterni a cui si fa riferimento: le cartelle di lavoro non lette non sono state aperte dal disco; le celle dipendenti usano cache interne incorporate o non hanno valore. Quando spieghi intervalli o vincoli, indica esplicitamente sia il limite inferiore sia quello superiore.
