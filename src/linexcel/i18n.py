...
UI_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "value_match_format": "The recalculated value matches the file, up to number formatting",
    ...
    "fr": {
        ...
        "value_match_format": "La valeur recalculée correspond au fichier, aux séparateurs près",
    ...
    "es": {
        ...
        "value_match_format": "El valor recalculado coincide con el archivo, salvo el formato numérico",
    ...
    "de": {
        ...
        "value_match_format": "Der neu berechnete Wert entspricht der Datei, bis auf die Zahlenformatierung",
    ...
    "it": {
        ...
        "value_match_format": "Il valore ricalcolato corrisponde al file, a meno della formattazione numerica",
    ...
    "pt": {
        ...
        "value_match_format": "O valor recalculado corresponde ao ficheiro, exceto na formatação numérica",
    ...
    "nl": {
        ...
        "value_match_format": "De herberekende waarde komt overeen met het bestand, op de getalnotatie na",
    ...
    "ja": {
        ...
        "value_match_format": "再計算した値は、数値の表記を除いてファイルと一致します",
    ...
    "zh": {
        ...
        "value_match_format": "重新计算的值与文件一致，仅数字格式不同",
